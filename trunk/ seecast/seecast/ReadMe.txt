================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : seecast Project Overview
===============================================================================

The application wizard has created this seecast application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your seecast application.
...
res\seecast.ico
    ...
    icon is included by the main resource file seecast.rc.
...
seecastDlg.h, seecastDlg.cpp - the dialog
    These files contain your CseecastDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's template is
    in seecast.rc, which can be edited in Microsoft Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CseecastDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named seecast.pch and a precompiled types file named StdAfx.obj.
